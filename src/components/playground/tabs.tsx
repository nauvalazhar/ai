...
export function TabsList({
  ...
  return (
    ...
    >
      ...
      <BaseTabs.Indicator
        className={cn(
          "absolute top-1/2 left-0 z-[-1] h-7.5 w-(--active-tab-width) translate-x-(--active-tab-left) -translate-y-1/2 rounded-xl bg-site-accent transition-all duration-200 ease-in-out",
        )}
      />
    </BaseTabs.List>
  );
